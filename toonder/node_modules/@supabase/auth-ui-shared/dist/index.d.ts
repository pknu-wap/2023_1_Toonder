...
declare type ViewType = ViewSignIn | ViewSignUp | ViewMagicLink | ViewForgottenPassword | ViewUpdatePassword;
interface ViewsMap {
    [key: string]: ViewType;
}
interface Theme {
...
export { AnimationTailwindClasses, AuthProviders, BaseAppearance, BaseAuth, CLASS_NAMES, I18nVariables, Localization, PREPENDED_CLASS_NAMES, RedirectTo, SocialButtonSize, SocialLayout, SocialLayouts, Theme, ThemeMinimal, ThemeSupa, ThemeVariables, VIEWS, ViewForgottenPassword, ViewMagicLink, ViewSignIn, ViewSignUp, ViewType, ViewUpdatePassword, ViewsMap, darkThemes, en, generateClassNames, merge, minimal, supabase, template };
