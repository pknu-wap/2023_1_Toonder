import { css as F, createStitches as l1, createTheme as o1 } from "@stitches/core";
import { generateClassNames as k, VIEWS as p, template as r1, merge as A, en as n1 } from "@supabase/auth-ui-shared";
import e, { useState as h, useRef as s1, useEffect as U, createContext as c1, useContext as a1 } from "react";
const i1 = F({
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...r,
      style: (l = t == null ? void 0 : t.style) == null ? void 0 : l.anchor,
      className: o.join(" ")
    },
    s
  );
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...w,
      style: (d = r == null ? void 0 : r.style) == null ? void 0 : d.button,
      className: f.join(" "),
      disabled: l
    },
    o,
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...r,
      style: (l = t == null ? void 0 : t.style) == null ? void 0 : l.container,
      className: o.join(" ")
    },
    s
  );
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...r,
      style: (l = t == null ? void 0 : t.style) == null ? void 0 : l.divider,
      className: o.join(" ")
    }
  );
}, h1 = F({
...
}), H = ({ children: s, appearance: t, ...r }) => {
  var l;
  const o = k(
    "input",
    h1({
      type: r.type === "password" ? "password" : "default"
    }),
    t
  );
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...r,
      style: (l = t == null ? void 0 : t.style) == null ? void 0 : l.input,
      className: o.join(" ")
    },
    s
  );
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...r,
      style: (l = t == null ? void 0 : t.style) == null ? void 0 : l.label,
      className: o.join(" ")
    },
    s
  );
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...r,
      style: (l = t == null ? void 0 : t.style) == null ? void 0 : l.message,
      className: o.join(" ")
    },
    s
  );
...
function K({
  ...
  var E;
  const [f, d] = h(""), [c, u] = h(""), [m, i] = h(""), [a, g] = h(!1), _ = async (C) => {
    var b;
    C.preventDefault(), u(""), i(""), g(!0);
    const { error: L } = await t.auth.signInWithOtp({
      email: f,
      options: { emailRedirectTo: r }
    });
    L ? u(L.message) : i((b = o == null ? void 0 : o.magic_link) == null ? void 0 : b.confirmation_text), g(!1);
  }, n = o == null ? void 0 : o.magic_link;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-magic-link", onSubmit: _ }, /* @__PURE__ */ e.createElement(M, { gap: "large", direction: "vertical", appearance: l }, /* @__PURE__ */ e.createElement(M, { gap: "large", direction: "vertical", appearance: l }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(D, { htmlFor: "email", appearance: l }, n == null ? void 0 : n.email_input_label), /* @__PURE__ */ e.createElement(
    H,
    {
      id: "email",
      name: "email",
      type: "email",
      autoFocus: !0,
      placeholder: n == null ? void 0 : n.email_input_placeholder,
    ...
    a ? n == null ? void 0 : n.loading_button_label : n == null ? void 0 : n.button_label
  )), w && /* @__PURE__ */ e.createElement(
    B,
    {
      href: "#auth-sign-in",
      onClick: (C) => {
        C.preventDefault(), s(p.SIGN_IN);
      },
      appearance: l
    },
    (E = o == null ? void 0 : o.sign_in) == null ? void 0 : E.link_text
  ), m && /* @__PURE__ */ e.createElement(z, { appearance: l }, m), c && /* @__PURE__ */ e.createElement(z, { color: "danger", appearance: l }, c)));
}
const x = F({
  width: "21px",
  height: "21px"
}), E1 = () => /* @__PURE__ */ e.createElement(
  "svg",
  {
    className: x(),
...
function D1({
  supabaseClient: s,
  socialLayout: t = "vertical",
  providers: r = ["github", "google", "azure"],
  redirectTo: o,
  onlyThirdPartyProviders: l = !0,
  view: w = "sign_in",
  i18n: f,
  appearance: d
}) {
  const [c, u] = h(!1), [m, i] = h(""), a = t === "vertical", g = async (n) => {
    u(!0);
    const { error: E } = await s.auth.signInWithOAuth({
      provider: n,
      options: { redirectTo: o }
    });
    E && i(E.message), u(!1);
  };
  function _(n) {
    const E = n.toLowerCase();
    return n.charAt(0).toUpperCase() + E.slice(1);
  }
  return /* @__PURE__ */ e.createElement(e.Fragment, null, r && r.length > 0 && /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(M, { gap: "large", direction: "vertical", appearance: d }, /* @__PURE__ */ e.createElement(
    M,
    {
    ...
    r.map((n) => {
      ...
      return /* @__PURE__ */ e.createElement(
        $,
        {
          key: n,
          color: "default",
          icon: E ? /* @__PURE__ */ e.createElement(E, null) : "",
          loading: c,
          onClick: () => g(n),
          appearance: d
        },
        a && r1((C = f == null ? void 0 : f[w]) == null ? void 0 : C.social_provider_text, {
          provider: _(n)
        })
      );
    })
  )), !l && /* @__PURE__ */ e.createElement(g1, { appearance: d })));
}
function q({
  authView: s = "sign_in",
  defaultEmail: t = "",
  ...
  var R, W, O, T;
  const a = s1(!0), [g, _] = h(t), [n, E] = h(r), [C, L] = h(""), [b, V] = h(!1), [N, S] = h("");
  U(() => (a.current = !0, _(t), E(r), () => {
    a.current = !1;
  }), [s]);
  const X = async (y) => {
    var G;
    switch (y.preventDefault(), L(""), V(!0), s) {
      case "sign_in":
        const { error: Z } = await f.auth.signInWithPassword({
          email: g,
          password: n
        });
        Z && L(Z.message);
      ...
      case "sign_up":
        ...
        j ? L(j.message) : e1 && !t1 && S((G = m == null ? void 0 : m.sign_up) == null ? void 0 : G.confirmation_text);
        break;
    }
    a.current && V(!1);
  }, P = (y) => {
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement(M, { direction: "vertical", gap: "large", appearance: i }, /* @__PURE__ */ e.createElement(M, { direction: "vertical", gap: "large", appearance: i }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(D, { htmlFor: "email", appearance: i }, v == null ? void 0 : v.email_label), /* @__PURE__ */ e.createElement(
      H,
      {
        id: "email",
        type: "email",
    ...
    )), /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(D, { htmlFor: "password", appearance: i }, v == null ? void 0 : v.password_label), /* @__PURE__ */ e.createElement(
      H,
      {
        id: "password",
        type: "password",
        name: "password",
        placeholder: v == null ? void 0 : v.password_input_placeholder,
        defaultValue: n,
      ...
      b ? v == null ? void 0 : v.loading_button_label : v == null ? void 0 : v.button_label
    ), d && /* @__PURE__ */ e.createElement(M, { direction: "vertical", gap: "small", appearance: i }, s === p.SIGN_IN && u && /* @__PURE__ */ e.createElement(
      B,
      {
        href: "#auth-magic-link",
        onClick: (y) => {
          y.preventDefault(), o(p.MAGIC_LINK);
        },
        appearance: i
      },
      (R = m == null ? void 0 : m.magic_link) == null ? void 0 : R.link_text
    ), s === p.SIGN_IN && /* @__PURE__ */ e.createElement(
      B,
      {
        href: "#auth-forgot-password",
        onClick: (y) => {
          y.preventDefault(), o(p.FORGOTTEN_PASSWORD);
        },
        appearance: i
      },
      (W = m == null ? void 0 : m.forgotten_password) == null ? void 0 : W.link_text
    ), s === p.SIGN_IN ? /* @__PURE__ */ e.createElement(
      B,
      {
        href: "#auth-sign-up",
        onClick: (y) => {
          y.preventDefault(), P(p.SIGN_UP);
        },
        appearance: i
      },
      (O = m == null ? void 0 : m.sign_up) == null ? void 0 : O.link_text
    ) : /* @__PURE__ */ e.createElement(
      B,
      {
        href: "#auth-sign-in",
        onClick: (y) => {
          y.preventDefault(), P(p.SIGN_IN);
        },
        appearance: i
      },
      (T = m == null ? void 0 : m.sign_in) == null ? void 0 : T.link_text
    ))),
    N && /* @__PURE__ */ e.createElement(z, { appearance: i }, N),
    C && /* @__PURE__ */ e.createElement(z, { color: "danger", appearance: i }, C)
  );
}
function Y({
  setAuthView: s = () => {
  ...
  const [f, d] = h(""), [c, u] = h(""), [m, i] = h(""), [a, g] = h(!1), _ = async (C) => {
    var b;
    C.preventDefault(), u(""), i(""), g(!0);
    const { error: L } = await t.auth.resetPasswordForEmail(f, {
      redirectTo: r
    });
    L ? u(L.message) : i((b = o == null ? void 0 : o.forgotten_password) == null ? void 0 : b.confirmation_text), g(!1);
  }, n = o == null ? void 0 : o.forgotten_password;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-forgot-password", onSubmit: _ }, /* @__PURE__ */ e.createElement(M, { gap: "large", direction: "vertical", appearance: l }, /* @__PURE__ */ e.createElement(M, { gap: "large", direction: "vertical", appearance: l }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(D, { htmlFor: "email", appearance: l }, n == null ? void 0 : n.email_label), /* @__PURE__ */ e.createElement(
    H,
    {
      id: "email",
      name: "email",
...
function J({
  ...
  const [o, l] = h(""), [w, f] = h(""), [d, c] = h(""), [u, m] = h(!1), i = async (g) => {
    var n;
    g.preventDefault(), f(""), c(""), m(!0);
    const { error: _ } = await s.auth.updateUser({ password: o });
    _ ? f(_.message) : c((n = t == null ? void 0 : t.update_password) == null ? void 0 : n.confirmation_text), m(!1);
  }, a = t == null ? void 0 : t.update_password;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-update-password", onSubmit: i }, /* @__PURE__ */ e.createElement(M, { gap: "large", direction: "vertical", appearance: r }, /* @__PURE__ */ e.createElement(M, { gap: "large", direction: "vertical", appearance: r }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(D, { htmlFor: "password", appearance: r }, a == null ? void 0 : a.password_label), /* @__PURE__ */ e.createElement(
    H,
    {
      id: "password",
      name: "password",
      placeholder: a == null ? void 0 : a.password_label,
      type: "password",
      autoFocus: !0,
    ...
    u ? a == null ? void 0 : a.loading_button_label : a == null ? void 0 : a.button_label
  )), d && /* @__PURE__ */ e.createElement(z, { appearance: r }, d), w && /* @__PURE__ */ e.createElement(z, { color: "danger", appearance: r }, w)));
}
const Q = c1({ user: null, session: null }), $1 = (s) => {
  const { supabaseClient: t } = s, [r, o] = h(null), [l, w] = h((r == null ? void 0 : r.user) ?? null);
  U(() => {
    (async () => {
      var u;
      const { data: c } = await t.auth.getSession();
      o(c.session), w(((u = c.session) == null ? void 0 : u.user) ?? null);
    })();
    const { data: d } = t.auth.onAuthStateChange(
      async (c, u) => {
        o(u), w((u == null ? void 0 : u.user) ?? null);
      }
    );
    return () => {
      d == null || d.subscription.unsubscribe();
    };
  }, []);
  const f = {
    session: r,
  ...
  return /* @__PURE__ */ e.createElement(Q.Provider, { value: f, ...s });
}, I1 = () => {
  const s = a1(Q);
  if (s === void 0)
...
function I({
  ...
  const i = A(n1, m.variables ?? {}), [a, g] = h(o), [_, n] = h(""), [E, C] = h(""), L = a === "sign_in" || a === "sign_up";
  U(() => {
    var N, S;
    l1({
      theme: A(
        ((N = c == null ? void 0 : c.theme) == null ? void 0 : N.default) ?? {},
        ((S = c == null ? void 0 : c.variables) == null ? void 0 : S.default) ?? {}
      )
    });
  }, [c]);
  const b = ({ children: N }) => {
    ...
    return (
      ...
      /* @__PURE__ */ e.createElement(
        "div",
        {
          className: u !== "default" ? o1(
            A(
              // @ts-ignore
              c == null ? void 0 : c.theme[u],
              ((S = c == null ? void 0 : c.variables) == null ? void 0 : S[u]) ?? {}
            )
          ) : ""
        },
  ...
  U(() => {
    const { data: N } = s.auth.onAuthStateChange(
      (S) => {
        S === "PASSWORD_RECOVERY" ? g("update_password") : S === "USER_UPDATED" && g("sign_in");
      }
    );
    return g(o), () => N.subscription.unsubscribe();
  }, [o]);
  const V = {
    supabaseClient: s,
    setAuthView: g,
  ...
  switch (a) {
    case p.SIGN_IN:
      return /* @__PURE__ */ e.createElement(b, null, /* @__PURE__ */ e.createElement(q, { ...V, authView: "sign_in" }));
    case p.SIGN_UP:
      return /* @__PURE__ */ e.createElement(b, null, /* @__PURE__ */ e.createElement(
        q,
        {
          appearance: c,
          supabaseClient: s,
...
I.ForgottenPassword = Y;
I.UpdatePassword = J;
I.MagicLink = K;
I.UserContextProvider = $1;
I.useUser = I1;
export {
  I as Auth,
  q as EmailAuth,
  Y as ForgottenPassword,
  K as MagicLink,
  D1 as SocialAuth,
  J as UpdatePassword
};
